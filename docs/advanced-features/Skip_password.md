...
3. 关闭"其他设置"中的图示选项
   ...
   ![Autologon 下载页面](../img/skip_password/关闭此选项.png)
...
7. 如何关闭/禁用
   ...
   反着做一遍即可，先用命令行打开"用户账户"，然后再去设置勾选“为了提高安全性，仅允许对此设备上的Microsoft账户使用Windows Hello登录(推荐)”即可
...
无广：ai以下使用的智能插座为拼夕夕买的米家智能插座，软件用的小米手机自带的“米家”

   - 优点：可自由控制时间，更改开关机时间无需进入BIOS界面
...
2. 开启电脑的通电自启功能
   ...
   ![设置通电自启功能](../img/skip_password/通电自启-联想栗子.png)

3. 在控制软件(这里用的米家)中设置开关机时间

   - 一般建议设置3:45自动关机然后3:50自动开机，给电脑通电和断电之间间隔时间太短可能会让电脑觉得自己没断过电从而导致开机失败
