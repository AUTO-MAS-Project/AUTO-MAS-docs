...
![AUTO_MAA配置1](../img/AUTO_MAA-config-2.png)
2. 关闭 **MAA**，检查 `MAA.exe`，确保其无需以管理员身份运行。即确保 **MAA.exe > 右键 > 属性 > 兼容性 > 设置 > 以管理员身份运行此程序** 处于 **未勾选** 状态。
![AUTO_MAA配置2](../img/AUTO_MAA-config-3.png)
3. 进入 **脚本管理**，单击 **新建脚本** 并选择 **MAA脚本** 以添加脚本实例管理页面。
![AUTO_MAA配置3](../img/script-guide/maa/AUTO-MAA-1.png)
4. 在 **打开的脚本配置** 中的 **MAA路径** 单击 **选择文件夹**，打开 MAA 软件所在目录。
![AUTO_MAA配置4](../img/script-guide/maa/AUTO-MAA-2.png)
5. 在**模拟器管理**中选择模拟器和模拟器实例
  ...
  完成后，点击**右下角蓝色保存按钮**保存。![AUTO_MAA配置5](../img/script-guide/maa/AUTO-MAA-5.png)

6. 点击此处在MAA中配置
![AUTO_MAA配置6](../img/script-guide/maa/AUTO-MAA-6.png)
...
![AUTO_MAA配置7](../img/script-guide/maa/AUTO-MAA-6.png)

### 设置用户配置

1. 在 **脚本管理** 的脚本表格内，单击 **添加用户** 以添加一个用户。
![AUTO_MAA配置8](../img/script-guide/maa/AUTO-MAA-7.png)
2. 按照设置卡相关提示填写用户信息。
![AUTO_MAA配置9](../img/script-guide/maa/AUTO-MAA-8.png)
