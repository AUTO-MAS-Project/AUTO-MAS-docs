...
> Original by Eric Steven Raymond and Rick Moen. Source: [catb.org](http://www.catb.org/~esr/faqs/smart-questions.html).
>
...
Remember, there are many other users that are not experiencing your problem. Otherwise you would have learned about it while reading the documentation and searching the Web (you did do that before complaining, [didn't you](#before)?). This means that very probably it is you who are doing something wrong, not the software.
...
This question just begs for ["STFW"](#rtfm) as a reply.
